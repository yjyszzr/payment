...
public class RongUtil {
	...
	@Resource
	private ReapalSubmit reapalSummit;
	@Resource
	 ...
	 * @throws Exception
	 */
	public final RspRefundEntity refundOrderInfo(ReqRefundEntity reqEntity) throws Exception {
		...
		map.put("merchant_id", rongCfg.getMerchant_id());
		...
		String post;
		post = reapalSummit.buildSubmit(map, url);
	...
	public final BaseResult<RspOrderQueryEntity> queryOrderInfo(String orderNo){
		RspOrderQueryEntity rEntity = null;
		Map<String, String> map = new HashMap<String, String>();
		map.put("merchant_id", rongCfg.getMerchant_id());
		map.put("version", rongCfg.getVersion());
