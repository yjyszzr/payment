...
//		params.put("total", param.get("total"));
	...
	public void orderRefund(Map<String, Object> param) throws MalformedURLException {
		...
		// ************订单退款，全额退款，简单接口，无须验签************
		logger.info("华移支付:REFUND_URL={}",lidutil.getPATH() + lidutil.getREFUND_URL_METHOD());
		String result = sendPostMessage(new URL(lidutil.getPATH() + lidutil.getREFUND_URL_METHOD()), params);
