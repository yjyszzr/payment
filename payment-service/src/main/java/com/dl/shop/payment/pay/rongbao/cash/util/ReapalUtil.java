package com.dl.shop.payment.pay.rongbao.cash.util;
...
import com.dl.shop.payment.pay.rongbao.util.AES;
import com.dl.shop.payment.pay.rongbao.util.RSA;

public class ReapalUtil {

	protected static String privateKey = CashConfig.privateKey;// 私钥
	protected static String password = CashConfig.password;// 密码
	protected static String key = CashConfig.key;// 用户key
	protected static String merchant_id = CashConfig.merchant_id;// 商户ID
	protected static String pubKeyUrl = CashConfig.pubKeyUrl;// 公钥
	protected static String url = CashConfig.url;
	protected static String notify_url = CashConfig.notify_url;// 回调地址
	protected static String version = CashConfig.version;// 版本
	protected static String charset = CashConfig.charset;// 编码
	protected static String sign_type = CashConfig.sign_type;// 签名方式，暂时仅支持MD5
    ...
    public static Map<String, String> addkey(String json)throws Exception{
        ...
        //随机生成16数字
        String key = CashRandomUtil.getRandom(16);
